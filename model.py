...
class GPTConfig:
    ...
    attention_type: str = 'vanilla'  # options: 'vanilla', 'linformer', 'performer', 'nystrom'
    attention_config: dict = None  # Additional config for specific attention types
        ...
        for mn, m in self.named_modules():
            for pn, p in m.named_parameters():
                ...
                if pn.endswith('bias'):
                    ...
                    no_decay.add(fpn)
                elif pn.endswith('.E') or pn.endswith('.F'):  # Linformer projection matrices
                    decay.add(fpn)
